...
var CountryPickerModal = function (_a) {
    ...
    var ItemSeparator = (0, react_1.useCallback)(function () {
        return countryListConfig.showSeparator !== false ? (<react_native_1.View style={[styles.separator, countryListConfig.separatorStyle]}/>) : null;
    }, [countryListConfig.showSeparator, countryListConfig.separatorStyle]);
    var keyExtractor = (0, react_1.useCallback)(function (item) { return "".concat(item.code, "-").concat(item.dial_code); }, []);
